...
class Sample {
	public Sample() {System.out.println("** Sample 생성자 **"); } //생성자메서드
	public void begin() {System.out.println("** Sample begin 메서드 **"); } //begin메서드
	public void end() {System.out.println("** Sample end 메서드 **"); } //end메서드
